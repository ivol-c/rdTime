...
public final class GlobalScreen {
	...
	private static class EventDispatchTask implements Runnable {
		 ...
		 * @see #addNativeKeyListener(org.jnativehook.keyboard.NativeKeyListener)
		 */
		 ...
		 * @see org.jnativehook.mouse.NativeMouseEvent
		 * @see org.jnativehook.mouse.NativeMouseListener
		 * @see #addNativeMouseListener(org.jnativehook.mouse.NativeMouseListener)
		 */
		 ...
		 * @see #addNativeMouseMotionListener(org.jnativehook.mouse.NativeMouseMotionListener)
		 */
		 ...
		 * @see org.jnativehook.mouse.NativeMouseWheelEvent
		 * @see org.jnativehook.mouse.NativeMouseWheelListener
		 * @see #addNativeMouseWheelListener(org.jnativehook.mouse.NativeMouseWheelListener)
		 * @since 1.1
		 */
